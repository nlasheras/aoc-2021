...
After event finished, I took a closer look to the code. Managed to get a good speedup by memoizing `count_leaves`, that was quite heavily used on the tree traversals. Also I did some optimization by removing the `deepcopy` used on the addition. 
